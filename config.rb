...
activate :blog do |blog|
  ...
  blog.tag_template = "vlang/tag.html"
...
activate :blog do |blog|
  ...
  blog.name = 'systemverilog'
  blog.prefix = 'systemverilog/blog'
  ...
  blog.tag_template = "systemverilog/tag.html"
  # blog.calendar_template = "calendar.html"
...
activate :blog do |blog|
  ...
  blog.name = 'coverification'
  blog.prefix = 'coverification/blog'
  blog.permalink = "{year}/{month}/{day}/{title}.html"
  # blog.permalink = "{year}/{month}/{day}/{title}.html"
  # Matcher for blog source files
  # blog.sources = "{year}-{month}-{day}-{title}.html"
  ...
  blog.tag_template = "coverification/tag.html"
  # blog.calendar_template = "calendar.html"
...
helpers do
  ...
  def tag_list(resource, blog_name = nil)
    l = '<ul>'
    l += resource.data.tags.split(", ").collect{ |tag| "<li>#{link_to(tag, tag_path(tag, blog_name).sub('/' + blog_name, ''))}</li>" }.join
    l += '</ul>'
    l
  end

  def tag_links(resource, blog_name = nil)
    resource.data.tags.split(", ").collect{ |tag| link_to(tag, tag_path(tag, blog_name)) }.join(", ")
  end
end
